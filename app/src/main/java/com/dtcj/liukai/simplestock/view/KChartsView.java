...
import com.dtcj.liukai.simplestock.entity.KDJEntity;
import com.dtcj.liukai.simplestock.entity.MACDEntity;
import com.dtcj.liukai.simplestock.entity.MALineEntity;
import com.dtcj.liukai.simplestock.entity.OHLCEntity;
import com.dtcj.liukai.simplestock.entity.RSIEntity;
 ...
 * Created at: 16/4/22
 */
public class KChartsView extends GridChart implements OnTabClickListener {
    ...
    private final static int MIN_CANDLE_NUM = 10;   //显示的最小Candle数
    ...
    private List<OHLCEntity> mOHLCData; //OHLC数据
    private int mDataStartIndext;   //显示的OHLC数据起始位置
    ...
    private List<MALineEntity> MALineData;  //MA数据
